        ...
        return [
            {
                ...
                "transition": "cut",
                "lighting": "natural",
                "emotion_arc": {"start": "未知", "end": "关注", "intensity": "low"},
                "sound_effects": [],
                "bgm_mood": "suspense",
            ...
            },
            {
                ...
                "transition": "cut",
                "lighting": "motivated",
                "emotion_arc": {"start": "平静", "end": "紧张", "intensity": "medium"},
                "sound_effects": [],
                "bgm_mood": "dramatic",
                "start_state": opening[:160],
            ...
            },
            {
                ...
                "transition": "cut",
                "lighting": "contrast",
                "emotion_arc": {"start": "紧张", "end": "悬念", "intensity": "high"},
                "sound_effects": [],
                "bgm_mood": "tense",
    ...
    def _save_to_db(self, session, shots: list[dict], episode: int):
        ...
        for shot in shots:
            s = StoryboardShot(
                ...
                camera_speed=shot.get("camera_speed", "slow"),
                shot_purpose=shot.get("shot_purpose", "emotion"),
                transition=shot.get("transition", "cut"),
                lighting=shot.get("lighting", ""),
                emotion_arc=json.dumps(
                    shot.get("emotion_arc", {}), ensure_ascii=False
                ),
