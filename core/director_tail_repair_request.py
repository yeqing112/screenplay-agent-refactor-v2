...
def build_repair_request(*, root_cause: str, target_dimensions: list[str], relevant_opportunities: list[dict[str, Any]] = (), relevant_beats: list[Any] = (), relevant_shots: list[Any] = (), allowed_plan_shot_ids: list[str] = (), strategy_subset: dict[str, Any] | None = None, immutable_contract: dict[str, Any] | None = None, validator_findings: list[Any] = (), previous_intervention: Any = None, target_metric: dict[str, Any] | None = None, attempt: dict[str, Any] | None = None) -> dict[str, Any]:
    payload = {
