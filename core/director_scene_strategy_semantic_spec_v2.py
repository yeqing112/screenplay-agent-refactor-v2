...
def build_provider_skeleton(*, scene_id: str, beat_ids: list[str], character_ids: list[str], fact_ids: list[str] | None = None, prop_ids: list[str] | None = None, location_ids: list[str] | None = None) -> dict[str, Any]:
