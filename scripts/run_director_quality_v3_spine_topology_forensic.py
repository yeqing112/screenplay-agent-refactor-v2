...
def main():
    ...
    _write(ART/"director-quality-v3-current-stage-authority.json",{**pointer,"shot_architecture":{**_d(pointer.get("shot_architecture")),"generation_architecture_redesign":{**_d(_d(pointer.get("shot_architecture")).get("generation_architecture_redesign")),"spine_topology_canary":{**_d(_d(_d(pointer.get("shot_architecture")).get("generation_architecture_redesign")).get("spine_topology_canary")),"historical_status":"FAILED","experiment_validity":"INVALID","forensic_adjudication":"CLOSED","raw_spine_capability":"PROMISING","raw_topology_capability":"PROMISING","ready_for_final_recanary":True,"final_recanary_authorized":False,"atomic_expansion_canary_authorized":False,"production_shotplan":"HOLD"}}}})
