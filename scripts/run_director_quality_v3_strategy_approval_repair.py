...
def provider_free_preflight(rows: list[dict[str, Any]], profile: dict[str, Any]) -> dict[str, Any]:
    checks = {
        ...
        # This provider-free regression remains valid on descendants of the
        # last adjudication closure; requiring an ever-growing literal hash
        # list made harmless forensic/doc commits fail the preflight.
        "head_is_31ffb01": __import__("subprocess").run(["git", "merge-base", "--is-ancestor", "aa33aab", "HEAD"], cwd=ROOT).returncode == 0,
