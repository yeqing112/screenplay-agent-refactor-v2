    ...
    with Session() as session:
        ...
        for plan in plans:
            ...
            for projection in projections:
                handoff = {"materialization_set_id": set_row.id, "storyboard_shot_id": None, "plan_shot_id": projection["plan_shot_id"], "scene_id": scene_id, "shot_plan_authority_fingerprint": authority_fp, "storyboard_projection_fingerprint": projection["projection_fingerprint"], "asset_identity_bindings": projection["asset_bindings"], "continuity_contract": projection["continuity_contract"], "camera": projection["meta_info"].get("camera", {}), "duration": projection["duration"], "action_beats": projection["action_beats"], "entry_state": projection["start_state"], "exit_state": projection["end_state"]}
