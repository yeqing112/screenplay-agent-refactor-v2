...
**Status:** `DIRECTOR_V3_FINAL_RECANARY_ADJUDICATION_PASSED`
...
- Protocol valid: `3/3`; Canonical V3: `3/3`.
- Distinctiveness: `3/3`, all checked `True`.
...
18. Protocol valid: `3/3`.
19. Canonical V3: `3/3`.
20. Distinctiveness pairs: `3/3`, all checked `True`.
...
26. Adjudicated status: `DIRECTOR_V3_FINAL_RECANARY_ADJUDICATION_PASSED`.
...
`ADJUDICATED_FINAL_RECANARY_STATUS=DIRECTOR_V3_FINAL_RECANARY_ADJUDICATION_PASSED`
