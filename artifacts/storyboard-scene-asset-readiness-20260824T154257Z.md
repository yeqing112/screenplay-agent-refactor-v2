...
- 生成时间：2026-08-24T15:42:57.395079
- 模式：只读 / 未修改真实项目
- 确认令牌：`37737f7cd04f83e5`
- 项目数：1
- 阻塞项目数：0
- 分镜镜头数：14
- 真实场景资产数：2
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- |
| #75 深夜便利店 | 14 | 2 | 5 | 2 | 0 | 2 | 14 | ready | blocked |
...
| --- | ---: | --- | ---: | ---: | ---: | ---: | ---: | --- |
| 监控室 | 158 | ref_ready | 1 | 0 | 0 | 1 | 8 | 场景资产没有符合横构图比例的 selected/locked 参考图 |
| 便利店收银台 | 159 | ref_ready | 1 | 0 | 0 | 1 | 6 | 场景资产没有符合横构图比例的 selected/locked 参考图 |
