...
- 生成时间：2026-09-11T15:37:07.248922
- 模式：只读 / 未修改真实项目
- 确认令牌：`c3d49c00a59f9c6a`
- 项目数：3
- 阻塞项目数：0
- 分镜镜头数：8
- 真实场景资产数：3
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- |
| #990301 导演运行时灰度样本 | 3 | 1 | 2 | 1 | 0 | 0 | 0 | ready | ready |
| #990306 生产就绪度测试 | 2 | 1 | 1 | 1 | 0 | 0 | 0 | ready | ready |
| #990400 导演运行时灰度样本 | 3 | 1 | 6 | 1 | 0 | 0 | 0 | ready | ready |
## 使用建议
