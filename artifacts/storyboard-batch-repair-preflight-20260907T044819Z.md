...
- 生成时间：2026-09-07T04:48:19.684740
- 模式：dry-run / 未修改真实项目
- 临时项目：`book 999906`
- 确认令牌：`8191ec80b64c8260`
- 样本数：4
- error：4 -> 4
- warning：8 -> 8
- 可进入人工评审：否
...
| --- | --- | ---: | ---: | ---: | ---: | --- | --- |
| #14 三个和尚 | 1-22 | 1 | 1 | 3 | 3 | v1 / id 94 | ready |
| #14 三个和尚 | 1-24 | 1 | 1 | 3 | 3 | v1 / id 95 | ready |
| #14 三个和尚 | 1-20 | 1 | 1 | 1 | 1 | v1 / id 91 | ready |
| #14 三个和尚 | 1-21 | 1 | 1 | 1 | 1 | v1 / id 103 | ready |
