...
- Documented expected starting HEAD was `dbcfa83`; the corrective closure was applied on top of the already-pushed historical wiring commits without rewriting their artifacts.
...
- Regression evidence: Strategy V3 targeted `40 passed`; backend `1207 passed`; Golden `5/5`.
