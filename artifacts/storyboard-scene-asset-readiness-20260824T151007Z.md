...
- 生成时间：2026-08-24T15:10:07.305798
- 模式：只读 / 未修改真实项目
...
| --- | ---: | --- | ---: | ---: | ---: | ---: | --- |
| 监控室 | 158 | draft | 0 | 0 | 0 | 8 | 场景资产状态仍为 draft；场景资产仍使用分镜派生的 draft 描述；场景资产没有 selected/locked 参考图 |
| 便利店收银台 | 159 | draft | 0 | 0 | 0 | 6 | 场景资产状态仍为 draft；场景资产仍使用分镜派生的 draft 描述；场景资产没有 selected/locked 参考图 |
