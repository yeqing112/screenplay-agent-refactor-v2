...
- 生成时间：2026-09-11T14:55:09.990963
- 模式：只读 / 未修改真实项目
- 确认令牌：`813beaec1bdf26e5`
- 项目数：3
- 阻塞项目数：0
- 分镜镜头数：8
- 真实场景资产数：3
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- |
| #990301 导演运行时灰度样本 | 3 | 1 | 2 | 1 | 0 | 1 | 3 | ready | blocked |
| #990306 生产就绪度测试 | 2 | 1 | 1 | 1 | 0 | 1 | 2 | ready | blocked |
| #990400 导演运行时灰度样本 | 3 | 1 | 6 | 1 | 0 | 1 | 3 | ready | blocked |
...
| --- | ---: | --- | ---: | ---: | ---: | ---: | ---: | --- |
| 雨夜旧公寓门厅 | 2 | locked | 1 | 0 | 1 | 0 | 3 | 场景资产没有符合横构图比例的 selected/locked 参考图 |

### #990306 生产就绪度测试

| 场景名 | 资产ID | 资产状态 | 参考图 | 横构图图 | locked | selected | 受影响镜头 | 问题 |
| --- | ---: | --- | ---: | ---: | ---: | ---: | ---: | --- |
| 深夜便利店 | 1 | locked | 1 | 0 | 1 | 0 | 2 | 场景资产没有符合横构图比例的 selected/locked 参考图 |

### #990400 导演运行时灰度样本

| 场景名 | 资产ID | 资产状态 | 参考图 | 横构图图 | locked | selected | 受影响镜头 | 问题 |
| --- | ---: | --- | ---: | ---: | ---: | ---: | ---: | --- |
| 雨夜旧公寓门厅 | 3 | locked | 1 | 0 | 1 | 0 | 3 | 场景资产没有符合横构图比例的 selected/locked 参考图 |
