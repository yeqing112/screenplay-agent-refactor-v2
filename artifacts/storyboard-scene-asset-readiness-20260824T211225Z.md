...
- 生成时间：2026-08-24T21:12:25.341391
- 模式：只读 / 未修改真实项目
- 确认令牌：`dd855dea5a277b01`
- 项目数：1
- 阻塞项目数：0
- 分镜镜头数：20
- 真实场景资产数：32
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- |
| #5 神农架历险记 | 20 | 32 | 7 | 3 | 0 | 3 | 20 | ready | blocked |
...
| --- | ---: | --- | ---: | ---: | ---: | ---: | ---: | --- |
| 部落营地 | 109 | draft | 1 | 1 | 0 | 1 | 8 | 场景资产状态仍为 draft |
| 原始丛林上空 | 120 | draft | 1 | 1 | 0 | 1 | 6 | 场景资产状态仍为 draft |
| 原始丛林深处 | 121 | draft | 1 | 1 | 0 | 1 | 6 | 场景资产状态仍为 draft |
