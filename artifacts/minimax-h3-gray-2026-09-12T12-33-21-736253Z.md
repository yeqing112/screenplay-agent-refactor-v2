...
- reference_publish_requires_storage_confirmation
- compiled_reference_images_not_provider_accessible

## Warnings

- unstable_public_asset_domain_allowed_for_this_gray_only
...
python scripts/validate-minimax-h3-gray.py --book-id 990400 --episode 1 --shot-id 1 --allow-real --publish-reference-images --allow-unstable-public-assets
```
