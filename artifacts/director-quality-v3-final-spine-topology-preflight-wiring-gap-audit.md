...
- Baseline reference HEAD: `92b6d77`; current as-built HEAD: `978dd02`. Ancestry is checked against the immutable closure base artifact (`510cf82`).
...
`FINAL_RECANARY_EXPECTED_BASE_COMMIT=510cf82`
