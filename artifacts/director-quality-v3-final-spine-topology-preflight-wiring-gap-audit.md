...
- Baseline reference HEAD: `92b6d77`; current as-built HEAD: `98f9991`. Ancestry is checked against the immutable closure base artifact (`98f9991`).
...
`FINAL_RECANARY_EXPECTED_BASE_COMMIT=98f9991`
