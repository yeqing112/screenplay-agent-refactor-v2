...
- Baseline reference HEAD: `92b6d77`; current as-built HEAD: `dbcfa83`. Ancestry is checked against the immutable closure base artifact (`1c5753d`).
...
`FINAL_RECANARY_EXPECTED_BASE_COMMIT=1c5753d`
