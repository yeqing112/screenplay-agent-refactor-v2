...
- 生成时间：2026-09-11T16:00:23.809480
- 模式：只读 / 未修改真实项目
- 确认令牌：`80d79666676ae6c9`
- 项目数：3
- 阻塞项目数：0
- 分镜镜头数：8
- 真实场景资产数：3
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- |
| #990301 导演运行时灰度样本 | 3 | 1 | 3 | 1 | 0 | 1 | 3 | ready | blocked |
| #990306 生产就绪度测试 | 2 | 1 | 2 | 1 | 0 | 1 | 2 | ready | blocked |
| #990400 导演运行时灰度样本 | 3 | 1 | 7 | 1 | 0 | 1 | 3 | ready | blocked |
