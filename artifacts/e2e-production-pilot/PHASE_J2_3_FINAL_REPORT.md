...
- Full backend final-head rerun on `6e44dbe`: `1760 passed, 4 failed` (1764 collected). The J2.3 targeted suites and Phase I deterministic pilot are green. The four failures match the recorded baseline family and are outside this change: offline replay branch provenance; real-path historical recanary reason; active gray registry configuration; and targeted missing-fact snapshot mutation.
