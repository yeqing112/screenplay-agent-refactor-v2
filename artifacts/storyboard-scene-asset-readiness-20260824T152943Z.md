...
- 生成时间：2026-08-24T15:29:43.955814
- 模式：只读 / 未修改真实项目
...
| --- | ---: | --- | ---: | ---: | ---: | ---: | --- |
| 监控室 | 158 | draft | 1 | 0 | 1 | 8 | 场景资产状态仍为 draft；场景资产仍使用分镜派生的 draft 描述 |
| 便利店收银台 | 159 | draft | 1 | 0 | 1 | 6 | 场景资产状态仍为 draft；场景资产仍使用分镜派生的 draft 描述 |
